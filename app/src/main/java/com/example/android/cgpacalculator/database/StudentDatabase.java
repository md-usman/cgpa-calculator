    ...
    public static final RoomDatabase.Callback roomCallBack = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull @NotNull SupportSQLiteDatabase db) {
            ...
            Executors.newSingleThreadExecutor().execute(() -> {
                ...
                Log.d("TESTING", "Inserting Values in DB");
                StudentDao studentDao = instance.databaseDao();

                studentDao.deleteAllStudents();
                studentDao.insert(new Student("4MH18XXXXX", "Meisam", "Information Science And Technology"));
                ...
                studentDao.insert(new Marks(6,"18XX64", 0, 0));
                studentDao.insert(new Marks(6,"18XX65", 0, 0));
                ...
                studentDao.insert(new Marks(7,"18XX73", 0, 0));
                studentDao.insert(new Marks(7,"18XX74", 0, 0));
                studentDao.insert(new Marks(7,"18XX75", 0, 0));
                ...
                studentDao.insert(new Marks(8,"18XX82", 0, 0));
                ...
                Log.d("TESTING", "Done inserting Values in DB, " + (System.currentTimeMillis() - now) / 1000f + "s");
